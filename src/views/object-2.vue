<template>
  <div class="object-2">
    <div class="layout-content">
      ...
      <Card dis-hover shadow style="width:710px">
            ...
            <pre>
              <code>
                function Person(name, age) {
                  ...
                  //this.say = new Function('return this.name + this.age') 与下面代码等价
                  this.say = function() {
                    return this.name + this.age
                  }
                }
      ...
      <Card dis-hover shadow style="width:600px">
        <h3 slot="title">4.构造 + 原型模式的组合模式（常用模式）</h3>
        <div>
          <p>
      ...
      <Card dis-hover shadow style="width:600px">
        ...
        <div>
          <p>稳妥对象：没有公共属性，其属性不引用this。稳妥对象何时最一些安全的环境中(这些环境会禁止使用this和new)。</p>
          <div v-highlight>
            <pre>
              <code>
                function Person(name, age) {
