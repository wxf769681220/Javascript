  ...
  <div class="array-2">
    <div class="layout-content">
      ...
      <Card dis-hover shadow style="width:600px">
        <h3 slot="title">3.sort()</h3>
        <div>
          <p>按一定规则对数组项进行排序，返回排序后的数组。当不带参数调用sort()时，数组项以字母表顺序排序(必要时讲临时转化为字符串进行比较)。</p>
          <div v-highlight>
            <pre>
              <code>
                //以字母表顺序排序
          ...
          <p>对于数值类型，或通过valueOf()方法返回数值类型的对象类型，可以使用更简单的比较函数。</p>
          <div v-highlight>
            <pre>
              <code>
      ...
      <Card dis-hover shadow style="width:540px">
        ...
        <div>
          ...
          <p>forEach()不能像for循环一样使用相应的break语句提前终止。若需要提前终止，必须把forEach()方法放在一个try块中，并能抛出一个异常。如果forEach()调用的函数抛出forEach.break异常，循环会提前终止。</p>
          <div v-highlight>
            <pre>
              <code>
