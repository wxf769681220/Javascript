    ...
    <div class="layout-content">
      <Card dis-hover shadow style="width:520px">
        ...
        <div>
          ...
          <p>在 firefox 中定时器的实现还能让你确定定时器过了多就才执行。（实际执行时间与指定的间隔的差值）</p>
          <div v-highlight>
            <pre>
              <code>
                // 仅支持firefox
      ...
      <Card dis-hover shadow style="width:520px">
        ...
        <div>
          <ul class="menu">
            ...
            <li>通常 setInterval() 间歇调用并不常用，而使用超时调用来实现间歇调用。可以通过以下链式 setTimeout()。</li>
      ...
      <Card dis-hover shadow style="width:540px">
        ...
        <div>
          <p>某些代码不可以在没有时间间隔的情况下连续重复的执行。比如：调整浏览器窗口大小的时候，会连续触发 onresize 事件。若尝试进行 DOM 操作，其高频率的更改
