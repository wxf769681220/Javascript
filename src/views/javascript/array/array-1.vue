<template>
  <div class="array-1">
    <Card shadow style="width:500px">
      <h3 slot="title">1.Javascript 中的数组</h3>
      <ul class="menu">
        <li>数据的有序列表。</li>
        <li>数组项可以保存任何数据类型。</li>
    ...
    <Card shadow style="width:500px">
      ...
      <div>
        <p>
          数组的 length 属性决定了数组的长度。设置 length 值时，若数组的实际数组项小于 length 的值，则使用 undefined 值填充数组；若数组的实际数组项大于 length 的值，
          那么数组将从末尾删除多余的数组项。
        </p>
        <div v-highlight>
          <pre>
    ...
    <Card shadow style="width:620px">
      ...
      <p>
        当 web 浏览器中有多个窗口或窗体（frame）存在，每个窗口都有自己的 javascript 环境，都有自己的全局对象。这时使用 instanceof 操作符用于数组检测并不可靠，
        可以使用 Array.isArray() 函数。
      </p>
      <div>
        <div v-highlight>
          <pre>
